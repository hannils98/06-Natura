 ...
 // Add pop-up
    map.on('click', function(e) {
        ...
        var popup = new mapboxgl.Popup({ offset: [0, -15] })
            ...
            .setHTML('<h3><a href="/'+ feature.properties.category +'/' + feature.properties.name +'/'+ feature.properties.id + '">' + feature.properties.name + '</a></h3><p>'+ feature.properties.description +'</p>')
            .addTo(map);
        });
